...
public class D3Test {
  ...
  public void tEST1LINKS() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//a[contains(@href, \'/reset\') and contains(text(), \'Reset\')]"));
  ...
  public void tEST2RESET() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[@id=\'listing\']/ul/li[1][contains(., \'ID 1. Jennyanydots\')]"));
      assert(elements.size() > 0);
    }
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[@id=\'listing\']/ul/li[2][contains(., \'ID 2. Old Deuteronomy\')]"));
      assert(elements.size() > 0);
    }
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[@id=\'listing\']/ul/li[3][contains(., \'ID 3. Mistoffelees\')]"));
      assert(elements.size() > 0);
    }
  }
  @Test
  ...
  public void tEST6RENT() {
    ...
    {
      List<WebElement> elements = driver.findElements(By.xpath("//div[@id=\'listing\']/ul/li[1][contains(., \'Rented out\')]"));
      assert(elements.size() > 0);
    }
    {
